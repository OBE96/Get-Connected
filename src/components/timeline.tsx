    ...
    return ( 
        <main className="relative px-[5%] py-[150px] bg-darkpurple border-b border-1 border-gray-600 grid grid-cols-1 overflow-hidden" id="timeline">
            <section className="relative z-10 w-full flex flex-col items-center justify-center mb-10">
                <h1 className="text-[28px] md:text-4xl text-white font-bold mb-3 text-center" data-aos="fade-down">Timeline</h1>
                <p className="text-lg text-white font-medium font-mon leading-loose text-center w-full lg:w-[40%]" data-aos="fade-down">Here is the breakdown of the time we anticipate 
using for the upcoming event.</p>
            ...
            <section className=" relative z-10 flex flex-col lg:flex-row items-center justify-center border-r-0 lg:border-l-0 border-l-4 border-purple pl-10 lg:pl-0 gap-8 lg:gap-0 mb-20 lg:mb-0 ml-5 md:ml-10 lg:ml-0">
                <div className="relative p-0 lg:py-[20px] lg:px-[50px] w-full lg:w-[50%] border-r-0 lg:border-r-4 border-purple flex flex-col items-start lg:items-end">
                    <h1 className="text-2xl font-medium text-purple text-left lg:text-right" data-aos="fade-down">Hackathon Announcement</h1>
                    <p className="text-[16px] text-mon text-left lg:text-right text-white tracking-wider w-full lg:w-[70%]" data-aos="fade-down">The getlinked tech hackathon 1.0 is formally announced to the general public and teams begin to get ready to register</p>
            ...
            <section className="relative z-10 flex lg:flex-row flex-col-reverse items-center justify-center border-r-0 lg:border-l-0 border-l-4 border-purple pl-10 lg:pl-0 gap-8 lg:gap-0 mb-20 lg:mb-0 ml-5 md:ml-10 lg:ml-0">
                ...
                <div className="p-0 lg:py-[20px] lg:px-[50px] w-full lg:w-[50%] h-full">
                    <h1 className="text-2xl font-medium  text-purple" data-aos="fade-down">Teams Registration begins</h1>
                    <p className="text-[16px] text-mon text-left text-white tracking-wider w-full lg:w-[80%]" data-aos="fade-down">Interested teams can now show their interest in the getlinked tech hackathon 1.0 2023 by proceeding to register</p>
                </div>
            ...
            <section className=" relative z-10 flex flex-col lg:flex-row items-center justify-center border-r-0 lg:border-l-0 border-l-4 border-purple pl-10 lg:pl-0 gap-8 lg:gap-0 mb-20 lg:mb-0 ml-5 md:ml-10 lg:ml-0">
                <div className="relative p-0 lg:py-[20px] lg:px-[50px] w-full lg:w-[50%] border-r-0 lg:border-r-4 border-purple flex flex-col items-start lg:items-end">
                    <h1 className="text-2xl font-medium text-purple text-left lg:text-right" data-aos="fade-down">Teams Registration ends</h1>
                    <p className="text-[16px] text-mon text-left lg:text-right text-white tracking-wider w-full lg:w-[60%]" data-aos="fade-down">Interested Participants are no longer Allowed to register</p>
            ...
            <section className="relative z-10 flex lg:flex-row flex-col-reverse items-center justify-center border-r-0 lg:border-l-0 border-l-4 border-purple pl-10 lg:pl-0 gap-8 lg:gap-0 mb-20 lg:mb-0 ml-5 md:ml-10 lg:ml-0">
                ...
                <div className="p-0 lg:py-[20px] lg:px-[50px] w-full lg:w-[50%] h-full">
                    <h1 className="text-2xl font-medium text-purple text-left" data-aos="fade-down">Announcement of the accepted teams
and ideas</h1>
                    <p className="text-[16px] text-mon text-left text-white tracking-wider w-full lg:w-[80%]" data-aos="fade-down">All teams whom idea has been accepted into getlinked tech hackathon 1.0 2023 are formally announced</p>
                </div>
            ...
            <section className="relative z-10 flex flex-col lg:flex-row items-center justify-center border-r-0 lg:border-l-0 border-l-4 border-purple pl-10 lg:pl-0 gap-8 lg:gap-0 mb-20 lg:mb-0 ml-5 md:ml-10 lg:ml-0">
                <div className="relative p-0 lg:py-[20px] lg:px-[50px] w-full lg:w-[50%] border-r-0 lg:border-r-4 border-purple flex flex-col items-start lg:items-end">
                    <h1 className="text-2xl font-medium text-purple text-left lg:text-right" data-aos="fade-down">Getlinked Hackathon 1.0 Offically Begins</h1>
                    <p className="text-[16px] text-mon text-left lg:text-right text-white tracking-wider w-full lg:w-[60%]" data-aos="fade-down">Accepted teams can now proceed to build their ground breaking skill driven solutions</p>
            ...
            <section className="relative z-10 flex lg:flex-row flex-col-reverse items-center justify-center border-r-0 lg:border-l-0 border-l-4 border-purple pl-10 lg:pl-0 gap-8 lg:gap-0 mb-20 lg:mb-0 ml-5 md:ml-10 lg:ml-0">
                ...
                <div className="p-0 lg:py-[20px] lg:px-[50px] lg:pb-0 w-full lg:w-[50%] h-full">
                    <h1 className="text-2xl font-medium text-purple text-left" data-aos="fade-down">Demo Day</h1>
                    <p className="text-[16px] text-mon text-left text-white w-full lg:w-[70%]" data-aos="fade-down">Teams get the opportunity to pitch their projects to judges. The winner of the hackathon will also be announced on
this day</p>
                </div>
